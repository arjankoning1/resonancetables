...
unalias -a
echo
echo "       RESONANCETABLES installation (Version December 29 2024) (C) Copyright 2024 Arjan Koning All Rights Reserved"
echo
echo " Two ways to use this script:"
echo
echo " install_resonancetables.bash 'Arjan Koning'"
echo "     (Replace  Arjan Koning by your own name"
echo
echo " or"
echo
echo " install_resonancetables.bash"
...
chmod a+x $pfile
code_build.bash resonancetables
