set title "Fission resonance integral" font ",25"
...
set output "bin.If.eps"
plot \
"cendl3.2_bin.If" u 1:2   title "CENDL-3.2" w histeps linestyle 1, \
"jeff4.0_bin.If" u 1:2  title "JEFF4.0" w histeps linestyle 2, \
"endfb8.1_bin.If" u 1:2   title "ENDFB8.1" w histeps linestyle 3, \
"jendl5.0_bin.If" u 1:2   title "JENDL5.0" w histeps linestyle 4, \
"tendl.2025_bin.If" u 1:2   title "TENDL-2025" w histeps linestyle 5, \
#   "dum" u 1:2 notitle
